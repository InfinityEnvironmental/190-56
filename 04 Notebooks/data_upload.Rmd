...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_126(08.07.2026).pdf"
...
WHERE sample_date = '2026-07-06' AND monitoring_group = 'routine';
```
...
SELECT
  'XCS26' AS site_id,
  '2026-06-26'::date AS sample_date,
  '10:10'::time AS sample_time,
  '2026-06-28'::date AS analysis_completed,
   7.8 AS sample_temp_c,
  '50' AS censored_value,
  'Strand_40(26.06.2026).pdf' AS filename,
  'WLAB'::coastal.lab AS lab_code,
  'daily'::coastal.monitoring_group AS monitoring_group;
```

```{sql connection = con}
SELECT * FROM coastal.results WHERE sample_date = '2026-06-26' AND monitoring_group = 'daily';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Strand Daily/2026/Strand_47(07.07.2026).pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2026-07-07';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Atlantic Daily/Daily_46(07.07.2026).pdf"
