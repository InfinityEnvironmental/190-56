...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_127(08.07.2026).pdf"
...
WHERE sample_date = '2026-07-08' AND monitoring_group = 'routine';
```
