...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_120(30.06.2025).pdf"
...
WHERE sample_date = '2025-06-30' AND monitoring_group = 'routine';
```
...
SELECT
  'XCN03' AS site_id,
  '2025-06-10'::date AS sample_date,
  '09:51'::time AS sample_time,
  '2025-06-12'::date AS analysis_completed,
   3.1 AS sample_temp_c,
  '5' AS enterococci_cfu_per_100ml,
  'Infinity Environmental AD.161(FB)' AS filename,
  'WLAB'::coastal.lab AS lab_code,
  'routine'::coastal.monitoring_group AS monitoring_group;
```

```{sql connection = con}
SELECT * FROM coastal.results WHERE sample_date = '2025-06-10' AND monitoring_group = 'routine';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Strand Daily/Oelofse G.115.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2025-06-30';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Atlantic Daily/Infinity Environmental AD.175.pdf"
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Triplicate Sampling/Infinity Environmental AD.176(FB).pdf"
...
triplicates <- read_xlsx("../../Infinity/Coastal Water Quality - Documents/Shared Results/Triplicate Sampling/triplicate_sampling_to_populate.xlsx") |>
...
FROM triplicates
WHERE sample_date >= '2025-05-01' AND lab_code = 'SSVC';
```
