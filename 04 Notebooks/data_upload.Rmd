...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_121(01.07.2025).pdf"
...
WHERE sample_date = '2025-07-01' AND monitoring_group = 'routine';
```
