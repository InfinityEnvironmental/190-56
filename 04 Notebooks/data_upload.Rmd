...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_57(30.03.2026).pdf"
...
tbl <- tibble(number = sample_number,
  ...
  mutate(site_id = if_else(site_id == "CNS30", "XCS30", site_id))
...
WHERE sample_date = '2026-03-30' AND monitoring_group = 'routine';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Strand Daily/Oelofse G.56.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2026-03-30';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Atlantic Daily/Infinity Environmental AD.76.pdf"
...
request <- request("https://wnrvdvesovnkmqbhkhjz.supabase.co/rest/v1/") |>
  req_url_path_append("results_view") |>
  req_headers(
    "apikey" = "sb_publishable_WdjSFiirJ1Hf5R46QXHgTQ_JTCXC9Wb",
    "Authorization" = "Bearer sb_publishable_WdjSFiirJ1Hf5R46QXHgTQ_JTCXC9Wb",
...
# Now I want to authenticate
Sys.setenv(
  "SUPABASE_ANON_KEY" = "sb_publishable_WdjSFiirJ1Hf5R46QXHgTQ_JTCXC9Wb",
  "SUPABASE_AUTH_URL" = "https://wnrvdvesovnkmqbhkhjz.supabase.co/auth/v1/"
  )

request(str_c(Sys.getenv("SUPABASE_URL"), "token?grant_type=password")) |>
  req_headers(
