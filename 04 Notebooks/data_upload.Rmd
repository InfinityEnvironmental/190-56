...
blue_flag <- extracted |>
  ...
  mutate(ecoli = str_extract(ecoli, "(?<=5221)(.*)$") |> str_extract("(ND|>150|\\d{1,3})")) |>
  ...
  # Map to site IDs
   mutate(site_id = case_when(
    ...
    site_name |> str_to_lower() |> str_detect("melkbosstrand") ~ "XCN07",
    ...
    site_name |> str_to_lower() |> str_detect("silwerstroom") ~ "XCN14",
