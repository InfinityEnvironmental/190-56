...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_38(03.03.2026).pdf"
...
WHERE sample_date = '2026-03-03' AND monitoring_group = 'routine';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Strand Daily/Oelofse G.37.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2026-03-03';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Atlantic Daily/Infinity Environmental AD.44.pdf"
...
tibble(
  ...
  mutate(site_id = "CN16O") |>
  mutate(censored_value = "30") |>
  mutate(sample_time = "10:55") |>
...
```{sql, connection = con}
SELECT * FROM coastal.results WHERE sample_date = '2026-03-03' AND monitoring_group = 'adhoc';
```
