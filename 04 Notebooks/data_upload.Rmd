...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_62(02.04.2025).pdf"
...
1. Remove duplicates
1. Add site codes to the Blue Flag data
2. Differentiate between confluence sites and beach sites for Llandudno
3. Differentiate between Melkbos N and S
...
blue_flag |>
  group_by(site_name, sample_date) |>
  count() |>
  arrange(-n)

blue_flag |>
  filter(site_name == "Fish Hoek") |>
  arrange(sample_date)
```
