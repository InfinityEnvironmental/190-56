...
tibble(
  ...
  mutate(description = "Clifton South Beach") |>
  mutate(censored_value = "171") |>
  mutate(sample_time = "10:50") |>
  select(-pdf_data, -data) |>
  unnest() |>
  select(description, sample_date, sample_time, analysis_completed, sample_temp_c, censored_value, filename_short) |>
...
```{sql, connection = con}
SELECT * FROM coastal.results_adhoc WHERE sample_date = '2026-03-02';
```
