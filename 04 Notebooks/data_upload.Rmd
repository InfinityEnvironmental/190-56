...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_170(09.09.2025).pdf"
...
WHERE sample_date = '2025-09-09' AND monitoring_group = 'routine';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Strand Daily/Oelofse G.166.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2025-09-09';
```
