...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_144(01.08.2025).pdf"
...
WHERE sample_date = '2025-08-01' AND monitoring_group = 'routine';
```
...
SELECT
  'XCN03' AS site_id,
  '2025-07-08'::date AS sample_date,
  '10:40'::time AS sample_time,
  '2025-07-10'::date AS analysis_completed,
   2.6 AS sample_temp_c,
  '1' AS enterococci_cfu_per_100ml,
  'Infinity Environmental AD.184(FB).pdf' AS filename,
  'WLAB'::coastal.lab AS lab_code,
  'routine'::coastal.monitoring_group AS monitoring_group;
```

```{sql connection = con}
SELECT * FROM coastal.results WHERE sample_date = '2025-07-08' AND monitoring_group = 'routine';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Strand Daily/Oelofse G.138.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2025-07-31';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Atlantic Daily/Infinity Environmental AD.204.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2025-08-01';
```
