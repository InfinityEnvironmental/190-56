...
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/SSB CMB Monitoring/CWQ_250(31.12.2025).pdf"
...
WHERE sample_date = '2025-12-31' AND monitoring_group = 'routine';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Strand Daily/Oelofse G.236.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2025-12-12';
```
...
```{r extract-pdf}
# Select the pdf that you want to import
path <- "../../Infinity/Coastal Water Quality - Documents/Shared Results/Atlantic Daily/Infinity Environmental AD.316.pdf"
...
FROM coastal.results
WHERE monitoring_group = 'daily' AND sample_date = '2025-12-19';
```
