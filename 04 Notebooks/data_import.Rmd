...
# Create new numeric value from character data
lims <- lims |>
  filter(!is.na(enterococci_cfu_per_100ml)) |>
...
lims |>
  ...
  select(sample_date, site_id, lab_owner, analysis, enterococci_cfu_per_100ml, enterococci_cfu_per_100ml_numeric, sample_number) |>
