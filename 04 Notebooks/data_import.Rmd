...
```{r read-sabs}
sabs <- read_excel("../../Infinity/Infinity Projects - 190-56 Coastal WQ/07_Cleaned Data/Coastal WQ Weekly 2023-24_cleaned.xlsx",
           col_names = c(
             "site_description",
             "cct_code",
             "cct_code_updated",
...
faec2023 <- faecal |>
  filter(date >= "2023-10-03" & date <= "2024-11-06") |>
...
faec2023 |> mutate(dataset = "CCT") |>
  bind_rows(sabs |> mutate(dataset = "SABS")) |>
