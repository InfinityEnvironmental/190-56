...
filename = "../01 Input Data/Coastal Water Quality Data/1_Silverstroomstrand_Tidal_Pool_(XCN08).xlsm"
read_excel(filename, sheet = 2) |>
  mutate(
    Date = date(Date),
    Eco = as.integer(Eco)
    ) |>
  rename(date = Date, ecoli_cfu_per_100ml = Eco)
