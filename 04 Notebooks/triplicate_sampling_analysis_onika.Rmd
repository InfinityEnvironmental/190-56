...
```{r}
ggplot(data_clean, aes(x = site_id, y = enterococci_cfu_per_100ml, color = sample_date)) +
  geom_point() +
  geom_smooth(method = "loess", se = FALSE) +
  labs(title = "Enterococci Over Time by Site", y = "CFU per 100ml", x = "Site")
```
...
#Bar Plot
```{r}
ggplot(dat, aes(x = site_id, y = enterococci_cfu_per_100ml, fill = sample_date)) +
