...
(site_map <- ggplot() +
  ...
  geom_sf_text(data = sites_sf, aes(label = site_description), hjust = 1, check_overlap = TRUE, nudge_x = -100, colour = "white", family = "Century Gothic", size = unit(1.5, "mm")) +
...
ggsave("clifton_fourth.jpg", plot = infographic, path = "../../Infinity/Infinity Projects - Files/190-56 Coastal WQ/08_Reports/Know Your Coast/Draft Recreational Node Overviews/", width = 210, height = 223.8375, units = "mm", dpi = 600)
```