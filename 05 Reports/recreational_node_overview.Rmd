...
streets <- opq(sites_bbox) |>
  add_osm_feature("highway", c("motorway", "primary", "secondary", "tertiary", "trunk", "motorway_link", "trunk_link", "primary_link", "secondary_link", "tertiary_link", "unclassified", "residential")) |>
  osmdata_sf()
