...
exceedances <- sites |>
  ...
  filter(site_id == "XCS34", between(sample_date, "2024-01-01", "2025-01-01"), monitoring_group %in% c("routine", "daily")) |>
  collect() |>
  summarise(
    all_samples = n(),
...
sample_frequency <- sites |>
  inner_join(results, by = "site_id") |>
  filter(site_id == "XCS34" & between(sample_date, "2024-01-01", "2025-01-01")) |>
  collect() |>
