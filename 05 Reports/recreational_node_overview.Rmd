...
(site_map <- ggplot() +
  ...
  geom_sf_text(data = sites_sf, aes(label = site_description), hjust = 1, check_overlap = TRUE, nudge_x = -100, colour = "white", family = "Century Gothic", size = unit(2.6, "mm")) +
...
(dotplot <- ggplot(data = dotplot_data, aes(x = month_day, fill = monitoring_group)) +
  ...
  scale_y_continuous(NULL, breaks = NULL) +
    facet_wrap(~year, ncol = 3, scales = "free_y", switch = "x") +
  theme(
...
(results_plot <- sites |>
  ...
  geom_line(aes(y = numeric_value), size = unit(0.7, "mm")) +
...
reporting_period <- ggplot() +
  annotate(geom = "text", x = 0, y = 0, label = "Data only shown for reporting period (October 2023 to May 2025)", family = "Century Gothic", colour = "white") +
  theme(
    plot.background = element_blank(),
    panel.background = element_blank(),
    panel.grid = element_blank(),
...
(infographic <- base +
  ...
  inset_element(dotplot, left = unit(25, "mm"), bottom = unit(0, "mm"), right = unit(110, "mm"), top = unit(45, "mm"), align_to = "full") +
  ...
  inset_element(text, left = unit(120, "mm"), bottom = unit(105, "mm"), right = unit(210, "mm"), top = unit(150, "mm")) +
  inset_element(exceed_text, left = unit(116, "mm"), bottom = unit(10, "mm"), right = unit(206, "mm"), top = unit(80, "mm")) +
...
ggsave("milnerton_lighthouse.jpg", plot = infographic, path = "../../Infinity/Infinity Projects - Files/190-56 Coastal WQ/08_Reports/Know Your Coast/Draft Recreational Node Overviews/", width = 210, height = 223.8375, units = "mm", dpi = 600)
```