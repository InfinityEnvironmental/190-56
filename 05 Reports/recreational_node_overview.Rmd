...
(site_map <- ggplot() +
  ...
  geom_sf_text(data = sites_sf, aes(label = str_wrap(site_description, 25)), hjust = 1, nudge_x = -100, check_overlap = TRUE, colour = "white", family = "Century Gothic", size = unit(1.5, "mm")) +
...
wheel <- exceedances |>
  ...
  facet_grid(cols = vars("All"), switch = "x") +
...
text_seasonal <- seasonal_exceedances |>
  ggplot() + 
  geom_text(aes(x = 0, y = 0, label = str_c(samples_exceed_pct, "%", sep = "")), colour = "white", size = unit(6, "mm"), family = "Century Gothic") +
...
hazen_categories <- bind_rows(all, summer, winter) |>
  ...
  scale_fill_manual(name = "Hazen Water Quality Category", values = c("Poor" = "#D73027", "Sufficient" = "#FECC5C", "Good" = "#A6D96A", "Excellent" = "#3288BD")) +
...
results_plot <- sites |>
  ...
  labs(y = "Enterococci (cfu per 100 mL)") +
...
site_name <- sites |>
  ...
  mutate(coast_label = str_c(coastline, " Coast", sep = "")) |>
  ggplot() +
  geom_text(aes(x = 0, y = 1, label = str_wrap(site_description, 25)), angle = 90, size.unit = "mm", size = unit(9, "mm"), family = "Century Gothic", colour = "white", lineheight = 0.7) +
...
(infographic <- base +
  ...
  inset_element(coast, left = unit(0, "mm"), bottom = unit(3, "mm"), right = unit(23, "mm"), top = unit(70, "mm"), align_to = "full") +
  inset_element(site_name, left = unit(0, "mm"), bottom = unit(70, "mm"), right = unit(23, "mm"), top = unit(217, "mm"), align_to = "full") +
  ...
  inset_element(wheel, left = unit(120, "mm"), bottom = unit(105, "mm"), right = unit(210, "mm"), top = unit(150, "mm")) +
  inset_element(text, left = unit(120, "mm"), bottom = unit(105, "mm"), right = unit(210, "mm"), top = unit(155, "mm")) +
  inset_element(exceed_text, left = unit(118, "mm"), bottom = unit(10, "mm"), right = unit(208, "mm"), top = unit(60, "mm")) +
  inset_element(wheel_seasonal, left = unit(130, "mm"), bottom = unit(65, "mm"), right = unit(200, "mm"), top = unit(120, "mm")) +
  inset_element(text_seasonal, left = unit(130, "mm"), bottom = unit(67, "mm"), right = unit(200, "mm"), top = unit(122, "mm")) +
  inset_element(sample_threshold_title, left = unit(125, "mm"), bottom = unit(45, "mm"), right = unit(195, "mm"), top = unit(62, "mm")) +
