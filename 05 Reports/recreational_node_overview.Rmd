...
(site_map <- ggplot() +
  ...
  geom_sf_text(data = sites_sf, aes(label = str_wrap(site_description, 20)), hjust = 1, check_overlap = TRUE, nudge_x = -100, colour = "white", family = "Century Gothic", size = unit(1.5, "mm")) +
